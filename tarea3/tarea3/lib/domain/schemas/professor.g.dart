...
extension GetProfessorCollection on Isar {
  IsarCollection<Professor> get professors => this.collection();
}
...
Id _professorGetId(Professor object) {
  return object.id ?? Isar.autoIncrement;
}

List<IsarLinkBase<dynamic>> _professorGetLinks(Professor object) {
  return [object.courses];
}

void _professorAttach(IsarCollection<dynamic> col, Id id, Professor object) {
  object.id = id;
  object.courses.attach(col, col.isar.collection<Course>(), r'courses', id);
}

extension ProfessorQueryWhereSort
    on QueryBuilder<Professor, Professor, QWhere> {
  QueryBuilder<Professor, Professor, QAfterWhere> anyId() {
...
extension ProfessorQueryWhere
  ...
  QueryBuilder<Professor, Professor, QAfterWhereClause> idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Professor, Professor, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Professor, Professor, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension ProfessorQueryFilter
  ...
  QueryBuilder<Professor, Professor, QAfterFilterCondition> firstNameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Professor, Professor, QAfterFilterCondition> firstNameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Professor, Professor, QAfterFilterCondition> lastNameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Professor, Professor, QAfterFilterCondition> lastNameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension ProfessorQueryObject
    on QueryBuilder<Professor, Professor, QFilterCondition> {}

extension ProfessorQueryLinks
    on QueryBuilder<Professor, Professor, QFilterCondition> {
  QueryBuilder<Professor, Professor, QAfterFilterCondition> courses(
  ...
  QueryBuilder<Professor, Professor, QAfterFilterCondition> coursesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
...
extension ProfessorQuerySortBy on QueryBuilder<Professor, Professor, QSortBy> {
  QueryBuilder<Professor, Professor, QAfterSortBy> sortByFirstName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstName', Sort.asc);
    });
  }

  QueryBuilder<Professor, Professor, QAfterSortBy> sortByFirstNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstName', Sort.desc);
    });
  }

  QueryBuilder<Professor, Professor, QAfterSortBy> sortByLastName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastName', Sort.asc);
    });
  }

  QueryBuilder<Professor, Professor, QAfterSortBy> sortByLastNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProfessorQuerySortThenBy
    on QueryBuilder<Professor, Professor, QSortThenBy> {
  QueryBuilder<Professor, Professor, QAfterSortBy> thenByFirstName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstName', Sort.asc);
    });
  }

  QueryBuilder<Professor, Professor, QAfterSortBy> thenByFirstNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstName', Sort.desc);
    });
  }

  QueryBuilder<Professor, Professor, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<Professor, Professor, QAfterSortBy> thenByIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.desc);
    });
  }

  QueryBuilder<Professor, Professor, QAfterSortBy> thenByLastName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastName', Sort.asc);
    });
  }

  QueryBuilder<Professor, Professor, QAfterSortBy> thenByLastNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastName', Sort.desc);
    });
  }
...
extension ProfessorQueryWhereDistinct
    on QueryBuilder<Professor, Professor, QDistinct> {
  QueryBuilder<Professor, Professor, QDistinct> distinctByFirstName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Professor, Professor, QDistinct> distinctByLastName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ProfessorQueryProperty
    on QueryBuilder<Professor, Professor, QQueryProperty> {
  QueryBuilder<Professor, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<Professor, String?, QQueryOperations> firstNameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'firstName');
    });
  }

  QueryBuilder<Professor, String?, QQueryOperations> lastNameProperty() {
    return QueryBuilder.apply(this, (query) {
